...
class App {
    ...
    _init(){
        ...
        // this._setupModel_cn7car_effect()
    ...
    _setupModel_card_effect(){
        ...
        loader.load( url,  ( gltf ) => {
            ...
            this._cardEffect.scale.set(10,10,0)
            this._cardEffect.traverse(obj => {
                if(obj.isMesh){
                    obj.layers.set(0)
                }
            })
    ...
    _setupModel_cn7star_effect(){
        ...
        const animationDelay = 5500//애니메이션 딜레이
